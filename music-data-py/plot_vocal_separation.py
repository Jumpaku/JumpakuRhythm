...
y, sr = librosa.load('../asset/2019-05-23_0753.wav', sr=None, offset=0.0, duration=120.0)
...
vocal=librosa.util.fix_length(librosa.core.istft(S_foreground, dtype=y.dtype), len(y))
librosa.output.write_wav('../asset/vocal.wav', vocal, sr)
inst=librosa.util.fix_length(librosa.core.istft(S_background, dtype=y.dtype), len(y))
librosa.output.write_wav('../asset/inst.wav', inst, sr)
